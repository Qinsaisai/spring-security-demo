...
public class BaseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        ErrorDetails details = ErrorDetails.from(CommonErrorCode.INVALID_ARGUMENT, HttpStatus.BAD_REQUEST, request, ex, field, hints);
    ...
    protected ResponseEntity<Object> handleExceptionInternal(
        ...
        if (Objects.isNull(body)) {
            ErrorDetails details = ErrorDetails.from(CommonErrorCode.INVALID_REQUEST, status, request, ex, ex.getMessage());
            log.error(details.getMessage(), ex);
